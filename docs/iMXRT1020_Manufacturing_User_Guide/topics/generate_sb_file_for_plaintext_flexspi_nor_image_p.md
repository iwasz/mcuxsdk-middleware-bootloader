...
An example containing the above steps is shown in the figure below.<br>
**Example BD file for FlexSPI NOR programming**
![](../images/figure24.png "Example BD file for FlexSPI NOR programming")

Here is an example to generate SB file using the elftosb utility, ivt\_flexspi\_nor\_xip.bin, and BD file shown in the figure below.<br>
**Example command to generate SB file for FlexSPI NOR programming**
![](../images/flexspi_nor_programming.png "Example command to generate SB file for FlexSPI NOR
                    programming")
