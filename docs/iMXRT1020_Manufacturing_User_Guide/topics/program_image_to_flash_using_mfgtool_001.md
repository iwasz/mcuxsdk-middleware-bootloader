...
7.  Put the device\_name-EVK board to internal boot mode and select HyperFlash as boot device by setting SW7 to “1-OFF, 2-ON, 3-ON, 4-OFF”. Then reset the device to start running the application.

**Parent topic:**[Manufacturing process in Production phase](../topics/manufacturing_process_in_production_phase.md)
