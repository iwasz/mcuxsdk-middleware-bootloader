...
| --- | --- | --- |
| 0x00 - 0x03 | header |•   Byte 0 tag, fixed to 0xD1<br>•   Byte 1, 2 length, bit endian format containing the overall length of the IVT in bytes, fixed to 0x00, 0x20<br>•   Byte 3: version, valid values: 0x40, 0x41, 0x42, 0x43 |
...
| 0x0c - 0x0f | dcd | Absolute address of the image, set to NULL as DCDDCD is not supported on RT1010 |
