...
**Example command to generate SB file for FlexSPI NOR image encryption and programming**
![](../images/fig_28_2.png "Example command to generate SB file for FlexSPI NOR image encryption and programming")

After the command “program\_flexspinor\_image\_hyperflash\_qspinor\_encrypt.bd -o boot\_image.sb ivt\_flexspi\_nor\_xip\_signed\_nopadding.bin” in the figure above , a file named “boot\_image.sb” is generated in the folder that contains the elftosb utility executable.
