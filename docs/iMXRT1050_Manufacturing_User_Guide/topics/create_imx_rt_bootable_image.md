...
Using Chapter 4, *Generate i.MX RT botable image*, based on the memory map assigned for RT105x SoC, here are the steps to generate i.MX RT bootable image using elftosb utility.
