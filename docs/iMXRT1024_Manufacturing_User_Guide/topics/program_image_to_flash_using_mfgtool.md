...
3.  Put the device\_name-EVK board to Serial Downloader mode by setting SW8 to "0001".
...
7.  Put the device\_name-EVK board to internal boot mode and select FlexSPI as boot device by setting SW 8 to "0010". Then reset the device to start running application.