...
-   `MfgTool2.exe`: GUI Windows application to download and program an application image into the external flash device. cfg\_MXRT1010X.ini must be renamed to cfg.ini to use.
