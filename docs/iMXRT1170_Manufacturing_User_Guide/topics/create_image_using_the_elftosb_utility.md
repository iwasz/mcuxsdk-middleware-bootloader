...
1. Create the BD file for boot image generation. The BD file content is showed below. It is also available in the release package in “&lt;sdk\_package&gt;/middleware/mcu-boot/bin/Tools/bd\_file/imxrt117xfolder
