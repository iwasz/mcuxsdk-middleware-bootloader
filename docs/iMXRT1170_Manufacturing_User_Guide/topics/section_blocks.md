...
|Header\_UID|Generic \(matches any value\)<br />U0, U1,... Un<br />where each Ui=0..255 and nundefined255|
...
|AuthenticateCSF\_EngineConfiguration|Configuration flags for the hash engine. Note that the hash is computed over an internal RAM copy of the CSF <br/> Valid engine configuration values corresponding to engine name.|
