...
extern "C"
{
     ...
     */
    static inline void SPIFI_SetCommandAddress(SPIFI_Type *base, uint32_t addr) { base->ADDR = addr; }
     ...
     */
    static inline void SPIFI_SetIntermediateData(SPIFI_Type *base, uint32_t val) { base->IDATA = val; }
     ...
     */
    static inline void SPIFI_SetCacheLimit(SPIFI_Type *base, uint32_t val) { base->CLIMIT = val; }
     ...
     */
    static inline void SPIFI_EnableInterrupt(SPIFI_Type *base, uint32_t mask) { base->CTRL |= mask; }
     ...
     *                 enumeration :: spifi_interrupt_enable_t
     */
    static inline void SPIFI_DisableInterrupt(SPIFI_Type *base, uint32_t mask) { base->CTRL &= ~mask; }
     ...
     */
    static inline uint32_t SPIFI_GetStatusFlag(SPIFI_Type *base) { return base->STAT; }
     ...
     */
    static inline uint32_t SPIFI_GetDataRegisterAddress(SPIFI_Type *base) { return (uint32_t)(&(base->DATA)); }
     ...
     */
    static inline void SPIFI_WriteData(SPIFI_Type *base, uint32_t data) { base->DATA = data; }
     ...
     */
    static inline uint32_t SPIFI_ReadData(SPIFI_Type *base) { return base->DATA; }
