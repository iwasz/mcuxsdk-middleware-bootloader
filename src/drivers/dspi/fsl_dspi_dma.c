...
dspi_master_dma_private_handle_t g_dspiMasterDmaPrivateHandle[FSL_FEATURE_SOC_DSPI_COUNT];
dspi_slave_dma_private_handle_t g_dspiSlaveDmaPrivateHandle[FSL_FEATURE_SOC_DSPI_COUNT];
                                        ...
                                        dma_handle_t *dmaIntermediaryToTxRegHandle)
{
    ...
    g_dspiMasterDmaPrivateHandle[instance].base = base;
    g_dspiMasterDmaPrivateHandle[instance].handle = handle;
...
status_t DSPI_MasterTransferDMA(SPI_Type *base, dspi_master_dma_handle_t *handle, dspi_transfer_t *transfer)
{
    ...
    DMA_SetCallback(handle->dmaRxRegToRxDataHandle, DMA_DspiMasteRxCallback, &g_dspiMasterDmaPrivateHandle[instance]);

    DMA_SetCallback(handle->dmaIntermediaryToTxRegHandle, DMA_DspiMasteTxCallback,
                    &g_dspiMasterDmaPrivateHandle[instance]);
    ...
    {
        DMA_DspiMasteTxCallback(handle->dmaIntermediaryToTxRegHandle, &g_dspiMasterDmaPrivateHandle[instance]);
    }
                                       ...
                                       dma_handle_t *dmaTxDataToTxRegHandle)
{
    ...
    g_dspiSlaveDmaPrivateHandle[instance].base = base;
    g_dspiSlaveDmaPrivateHandle[instance].handle = handle;
...
status_t DSPI_SlaveTransferDMA(SPI_Type *base, dspi_slave_dma_handle_t *handle, dspi_transfer_t *transfer)
{
    ...
    DMA_SetCallback(handle->dmaRxRegToRxDataHandle, DMA_DspiSlaveRxCallback, &g_dspiSlaveDmaPrivateHandle[instance]);
