...
const property_interface_t g_propertyInterface = { bootloader_property_load_user_config, bootloader_property_init,
                                                   bootloader_property_get, NULL, // bootloader_property_set_uint32,
                                                   &g_propertyStore };
...
#endif // if defined(BL_TARGET_FLASH)
...
status_t bootloader_property_init(void)
{
    ...
    /// Initialize flash properties.
    {
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash0BlockBaseAddr,
            &propertyStore->flashStartAddress[kFlashIndex_Main]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash0TotalSize,
        ...
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash0AccessSegmentSize,
            &propertyStore->flashAccessSegmentSize[kFlashIndex_Main]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash0AccessSegmentCount,
            &propertyStore->flashAccessSegmentCount[kFlashIndex_Main]);

#if BL_HAS_SECONDARY_INTERNAL_FLASH
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1BlockBaseAddr,
            &propertyStore->flashStartAddress[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1TotalSize,
            &propertyStore->flashSizeInBytes[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1SectorSize,
            &propertyStore->flashSectorSize[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1BlockSize,
            &propertyStore->flashBlockSize[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1BlockCount,
            &propertyStore->flashBlockCount[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1FacSupport,
            &propertyStore->flashFacSupport[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1AccessSegmentSize,
            &propertyStore->flashAccessSegmentSize[kFlashIndex_Secondary]);
        g_bootloaderContext.flashDriverInterface->flash_get_property(
            g_bootloaderContext.allFlashState, kFLASH_PropertyPflash1AccessSegmentCount,
        ...
        {
            g_bootloaderContext.dflashDriverInterface->flash_get_property(
                g_bootloaderContext.dFlashState, kFLEXNVM_PropertyDflashBlockBaseAddr,
                &propertyStore->flashStartAddress[kFalshIndex_DFlash]);
            g_bootloaderContext.dflashDriverInterface->flash_get_property(
                g_bootloaderContext.dFlashState, kFLEXNVM_PropertyDflashTotalSize,
                &propertyStore->flashSizeInBytes[kFalshIndex_DFlash]);
            g_bootloaderContext.dflashDriverInterface->flash_get_property(
                g_bootloaderContext.dFlashState, kFLEXNVM_PropertyDflashSectorSize,
                &propertyStore->flashSectorSize[kFalshIndex_DFlash]);
            g_bootloaderContext.dflashDriverInterface->flash_get_property(
                g_bootloaderContext.dFlashState, kFLEXNVM_PropertyDflashBlockSize,
                &propertyStore->flashBlockSize[kFalshIndex_DFlash]);
            g_bootloaderContext.dflashDriverInterface->flash_get_property(
                g_bootloaderContext.dFlashState, kFLEXNVM_PropertyDflashBlockCount,
