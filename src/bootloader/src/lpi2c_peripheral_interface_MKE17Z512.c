...
static bool s_lpi2cActivity = false;
//static bool s_lpi2cIntialized = false;
...
// Code
////////////////////////////////////////////////////////////////////////////////
#define SCG_FIRC_48MHZ 48000000U /* Fast IRC trimed clock frequency(48MHz). */
...
//    uint32_t status = LPI2C_SlaveGetStatusFlags(baseAddr);
    uint32_t status = LPI2C_SlaveGetStatusFlags((LPI2C_Type *)LPI2C0_BASE);

    if (status & kLPI2C_SlaveAddressValidFlag)
    {
//        LPI2C_SlaveGetReceivedAddress(baseAddr);
        LPI2C_SlaveGetReceivedAddress((LPI2C_Type *)LPI2C0_BASE);
    }
...
//        s_lpi2cInfo.data_sink(sink_byte, instance);
        LPI2C_SlaveReceive((LPI2C_Type *)LPI2C0_BASE, &sink_byte, 1, actualRxSize);
        s_lpi2cInfo.data_sink(sink_byte, 0);
    }
...
//        LPI2C_SlaveSend(baseAddr, &source_byte, 1, actualTxSize);
        LPI2C_SlaveSend((LPI2C_Type *)LPI2C0_BASE, &source_byte, 1, actualTxSize);
    }
    if (status & kLPI2C_SlaveStopDetectFlag)
    {
//        LPI2C_SlaveClearStatusFlags(baseAddr, kLPI2C_SlaveStopDetectFlag);
        LPI2C_SlaveClearStatusFlags((LPI2C_Type *)LPI2C0_BASE, kLPI2C_SlaveStopDetectFlag);
    }
}
...
//    uint32_t baseAddr = g_lpi2cBaseAddr[instance];
    ...
    ((LPI2C_Type *)LPI2C0_BASE)->SCFGR2 |= (LPI2C_SCFGR2_FILTSDA(cycles) | LPI2C_SCFGR2_FILTSCL(cycles));
...
//    self->pinmuxConfig(self->instance, kPinmuxType_Peripheral);
    self->pinmuxConfig(0, kPinmuxType_Peripheral);
...
//                                                            LPI2C_SIER_RDIE_MASK | LPI2C_SIER_SDIE_MASK);
      LPI2C_SlaveInit((LPI2C_Type *)LPI2C0_BASE, &config, get_bus_clock());
      LPI2C_SlaveEnable((LPI2C_Type *)LPI2C0_BASE, true);
      LPI2C_SlaveEnableInterrupts((LPI2C_Type *)LPI2C0_BASE, LPI2C_SIER_AVIE_MASK | LPI2C_SIER_TDIE_MASK |
                                                            LPI2C_SIER_RDIE_MASK | LPI2C_SIER_SDIE_MASK);
...
//    ((LPI2C_Type *)baseAddr)->SCFGR1 |= LPI2C_SCFGR1_TXCFG_MASK;
     ((LPI2C_Type *)LPI2C0_BASE)->SCFGR1 |= LPI2C_SCFGR1_TXCFG_MASK;
...
//     lpi2c_set_glitch_filter_width(0, get_bus_clock(), kLPI2CGlitchFilterWidth_ns);
     lpi2c_set_glitch_filter_width(0, SCG_FIRC_48MHZ, kLPI2CGlitchFilterWidth_ns);
...
//        LPI2C_SlaveDeinit((LPI2C_Type *)baseAddr);
        LPI2C_SlaveDeinit((LPI2C_Type *)LPI2C0_BASE);
