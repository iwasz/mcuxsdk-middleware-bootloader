...
//static bool g_lpuartInitStatus = false;
...
//    status_t autoBaudCompleted = autobaud_get_rate(instance, &baud);
    status_t autoBaudCompleted = autobaud_get_rate(0, &baud);
...
//        if (LPUART_Init((LPUART_Type *)baseAddr, &userConfig, SCG_FIRC_48MHZ) == kStatus_Success)
        if (LPUART_Init((LPUART_Type *)LPUART0_BASE, &userConfig, SCG_FIRC_48MHZ) == kStatus_Success)
        {
...
//            LPUART_EnableInterrupts((LPUART_Type *)baseAddr, kLPUART_RxDataRegFullInterruptEnable);
            LPUART_EnableInterrupts((LPUART_Type *)LPUART0_BASE, kLPUART_RxDataRegFullInterruptEnable);

//            LPUART_EnableRx((LPUART_Type *)baseAddr, true);
//            LPUART_EnableTx((LPUART_Type *)baseAddr, true);
            LPUART_EnableRx((LPUART_Type *)LPUART0_BASE, true);
            LPUART_EnableTx((LPUART_Type *)LPUART0_BASE, true);
...
//        LPUART_Deinit((LPUART_Type *)baseAddr);
        LPUART_Deinit((LPUART_Type *)LPUART0_BASE);
    }
...
//    LPUART_WriteBlocking((LPUART_Type *)baseAddr, buffer, byteCount);
    LPUART_WriteBlocking((LPUART_Type *)LPUART0_BASE, buffer, byteCount);
    return kStatus_Success;
}
