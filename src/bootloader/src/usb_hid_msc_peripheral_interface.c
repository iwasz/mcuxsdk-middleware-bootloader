...
#endif
#elif defined(ANADIG_MISC_BASE) || defined(MIMXRT1189_cm33_SERIES) // add MIMXRT1189_cm33_SERIES because ANADIG_MISC_BASE has been removed on RT1180 new header file
