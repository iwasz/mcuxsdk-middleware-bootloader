...
{   
    ...
    {
        return (SYSCON->FCLKSEL[id] == 0U) ? CLOCK_GetCoreSysClkFreq() : 
               (SYSCON->FCLKSEL[id] == 1U) ? CLOCK_GetPllOutFreq() :
               (SYSCON->FCLKSEL[id] == 2U) ? CLOCK_GetUsbPllOutFreq() :
               (SYSCON->FCLKSEL[id] == 3U) ? CLOCK_GetFroHfFreq() :
               (SYSCON->FCLKSEL[id] == 4U) ? CLOCK_GetAudioPllOutFreq() : 0U;   
    }
