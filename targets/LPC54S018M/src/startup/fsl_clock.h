...
typedef enum _clock_attach_id
{
    ...
    kSYSTICK_DIV_CLK_to_SYSTICK_CLK = MUX_A(CM_STICKCLKSEL, 0),
    kWDT_OSC_to_SYSTICK_CLK = MUX_A(CM_STICKCLKSEL, 1),
    kOSC32K_to_SYSTICK_CLK = MUX_A(CM_STICKCLKSEL, 2),
    kFRO12M_to_SYSTICK_CLK = MUX_A(CM_STICKCLKSEL, 3),
    kNONE_to_SYSTICK_CLK = MUX_A(CM_STICKCLKSEL, 7),
    ...
    kFRO_HF_to_FLEXCOMM19 = MUX_A(CM_FXCOMCLKSEL10, 3),
    ...
    kWDT_OSC__to_DMIC = MUX_A(CM_DMICCLKSEL, 5),
