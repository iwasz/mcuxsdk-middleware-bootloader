...
- {id: SCG.SOSCDIV1.scale, value: '0', locked: true}
...
const scg_sosc_config_t g_scgSysOscConfig_BOARD_BootClockRUN =
    {
        ...
        .enableMode = kSCG_SysOscEnableErClk,     /* Enable OSCERCLK */
...
/*******************************************************************************
 ******************* Configuration BOARD_BootClockRUN_SIRC *********************
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
!!Configuration
name: BOARD_BootClockRUN_SIRC
outputs:
- {id: Core_clock.outFreq, value: 8 MHz}
- {id: LPO_clock.outFreq, value: 1 kHz}
- {id: SIRC_CLK.outFreq, value: 8 MHz}
- {id: Slow_clock.outFreq, value: 4 MHz}
...
/*******************************************************************************
 * Variables for BOARD_BootClockRUN_SIRC configuration
 ******************************************************************************/
const scg_sys_clk_config_t g_sysClkConfig_BOARD_BootClockRUN_SIRC =
    {
        .divSlow = kSCG_SysClkDivBy2,             /* Slow Clock Divider: divided by 2 */
#if FSL_CLOCK_DRIVER_VERSION < MAKE_VERSION(2, 1, 1)
        .reserved1 = 0,
...
const scg_sosc_config_t g_scgSysOscConfig_BOARD_BootClockRUN_SIRC =
    {
        .freq = 0U,                               /* System Oscillator frequency: 0Hz */
...
const scg_sirc_config_t g_scgSircConfig_BOARD_BootClockRUN_SIRC =
    {
...
const scg_firc_config_t g_scgFircConfig_BOARD_BootClockRUN_SIRC =
    {
        .enableMode = kSCG_FircEnable,            /* Enable FIRC clock */
...
const scg_spll_config_t g_scgSysPllConfig_BOARD_BootClockRUN_SIRC =
    {
        .enableMode = SCG_SPLL_DISABLE,           /* System PLL disabled */
        .monitorMode = kSCG_SysPllMonitorDisable, /* Monitor disabled */
        .div1 = kSCG_AsyncClkDisable,             /* System PLL Clock Divider 1: Clock output is disabled */
...
/*******************************************************************************
 * Code for BOARD_BootClockRUN_SIRC configuration
 ******************************************************************************/
void BOARD_BootClockRUN_SIRC(void)
{
    scg_sys_clk_config_t curConfig;

    /* Init FIRC. */
    CLOCK_CONFIG_FircSafeConfig(&g_scgFircConfig_BOARD_BootClockRUN_SIRC);
    /* Init SIRC. */
    CLOCK_InitSirc(&g_scgSircConfig_BOARD_BootClockRUN_SIRC);
    /* Set SCG to SIRC mode. */
    CLOCK_SetRunModeSysClkConfig(&g_sysClkConfig_BOARD_BootClockRUN_SIRC);
    /* Wait for clock source switch finished. */
    do
    {
         CLOCK_GetCurSysClkConfig(&curConfig);
    } while (curConfig.src != g_sysClkConfig_BOARD_BootClockRUN_SIRC.src);
    /* Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_BOOTCLOCKRUN_SIRC_CORE_CLOCK;
}
